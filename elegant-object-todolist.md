...
- [x] `src/Contracts/Event/EntityEventDispatcherInterface.php` [AUDITED]
- [x] `src/Contracts/Event/HasEventsInterface.php` [AUDITED]
- [x] `src/Contracts/Exception/ThrowableInterface.php` [AUDITED]
- [x] `src/Contracts/Filesystem/FilesystemInterface.php` [AUDITED]
- [x] `src/Contracts/Json/ToJsonInterface.php` [AUDITED]
- [x] `src/Contracts/Log/LoggableInterface.php` [AUDITED]
- [x] `src/Contracts/Log/LoggerInterface.php` [AUDITED]
- [x] `src/Contracts/Mailer/SendMailInterface.php` [AUDITED]
- [x] `src/Contracts/Null/NullableInterface.php` [AUDITED]
- [x] `src/Contracts/Persistance/AllowFlushInterface.php` [AUDITED]
- [x] `src/Contracts/Persistance/DatabaseEntityInterface.php` [AUDITED]
- [x] `src/Contracts/Persistance/DatabasePersistenceInterface.php` [AUDITED]
- [x] `src/Contracts/Response/ResponseInterface.php` [AUDITED]
- [x] `src/Contracts/Routing/RoutingInterface.php` [AUDITED]
- [x] `src/Contracts/Security/SecurityInterface.php` [AUDITED]
- [x] `src/Contracts/Security/UserInterface.php` [AUDITED]
- [x] `src/Contracts/Session/FlashBagInterface.php` [AUDITED]
- [x] `src/Contracts/Templating/TemplatingInterface.php` [AUDITED]
- [x] `src/Contracts/TryCatch/ExecutableTryCatchInterface.php` [AUDITED]
- [x] `src/Contracts/TryCatch/ThrowableHandlerCollectionInterface.php` [AUDITED]
- [x] `src/Contracts/TryCatch/ThrowableHandlerInterface.php` [AUDITED]
- [x] `src/Contracts/Types/TypeValidationInterface.php` [AUDITED]
